...
<body>
    ...
    <h3 class="text-center">LAPORAN DATA PEMBAYARAN</h3>
        ...
        <tbody>
            @foreach($pembayaran as $p)
                <tr>
                    ...
                    <td class="text-right">{{ number_format($p->kembalian, 0, ',', '.') }}</td>
                    <td class="text-center">{{ $p->status_bayar }}</td>
                    <td class="text-center">{{ \Carbon\Carbon::parse($p->bayar_tanggal)->format('d-m-Y') }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
